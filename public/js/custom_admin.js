...
(function($)
{
	...
	{
		var link = "http://localhost/website_ban_hang_quan_ao/admin";
		...
		// delete all news
		var $list_action 	= $('.list_actionss');//tim toi the co class = list_action
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn xóa tất cả dữ liệu ?'))
			{
				return false;
		...
		// delete all order
		var $list_action = $('.list_action_order');//tim toi the co class = list_action
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn xóa tất cả dữ liệu ?'))
			{
				return false;
		...
		// xóa các giao dịch
		var $list_action = $('.list_action_transaction');//tim toi the co class = list_action
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn xóa tất cả dữ liệu ?'))
			{
				return false;
			...
			//ajax để xóa POST
			$.ajax({
				url:link+'/transaction/deleteAll',
				type: 'POST',
				data : {'ids': ids},
		...
		// xóa các giao dịch
		var $list_action = $('.list_action_image');//tim toi the co class = list_action
		$list_action.find('#submit').click(function(){ //tim toi the co id = submit,su kien click
			if(!confirm('Bạn chắc chắn muốn xóa tất cả dữ liệu ?'))
			{
				return false;
