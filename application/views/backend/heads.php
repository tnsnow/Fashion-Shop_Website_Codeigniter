...
<title>Trạng Quản Trị Website Bán Hàng Thời Trang</title>

<meta name="robots" content="noindex, nofollow" />

<link rel="shortcut icon" href="<?php echo public_url('admin') ?>/images/icon.png" type="image/x-icon"/>
<link rel="stylesheet" type="text/css" href="<?php echo public_url('admin/crown') ?>/css/mains.css" />
...
<script type="text/javascript" src="<?php echo public_url('admin/crown') ?>/js/ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="<?php echo public_url('admin/crown') ?>/js/ckfinder/ckfinder.js"></script>
...
<script type="text/javascript" src="<?php echo public_url('admin/crown') ?>/js/func_ckfinder.js"></script>
