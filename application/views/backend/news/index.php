...
<div id="main_product" class="wrapper">
    ...
    <div class="widget">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
            ...
            <tr>
                <td colspan="6">
                    <div class="list_actionss itemActions">
                        <a url="<?php admin_url('news/deleteAll') ?>" class="button blueB" id="submit" href="#submit">
                ...
                <tr class="row_<?php echo $item -> id; ?>">
                    ...
                    <td>
                        <div class="image_thumb">
                            <img height="50" src="<?php echo  base_url('upload/news/'.$item -> image_link); ?>">
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="f11">
                            Đã xem:  <?php echo $item->count_view ?>
                        </div>
                    ...
                    <td class="option textC">
                        ...
                        <a title="Xem chi tiết bài viết" class="tipS" target="_blank" href="<?php echo base_url('news/view/'.$item->id) ?>">
                            <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
                        </a>
                        <a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('news/edit/'. $item->id) ?>">
                            <img src="<?php echo public_url('admin')?>/images/icons/color/edit.png">
                        </a>

                        <a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('news/delete/'. $item->id) ?>">
