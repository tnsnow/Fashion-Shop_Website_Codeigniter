                ...
                <div class="col-md-9">
                    ...
                    <div class="breadcrumb clearfix">
                        <ul>
                            ...
                            <li itemtype="" itemscope="" class="home">
                                <a title="<?php echo $category->name ?>" href="<?php echo base_url('news/listNewCate/'.$category->id).'/'.safe_title($category->name).'.html'; ?>" itemprop="url"><strong><?php echo $category->name ?></strong></a>
                            </li>
                    ...
                    <div class="news-content">
                        ...
                        <?php if (!empty($news)): ?>
                            ...
                            <div class="news-item clearfix">
                                <div class="col-md-3 col-sm-4 col-xs-12 image"><a href="<?php echo base_url('news/view/'.$item->id).'/'.safe_title($item->title).'.html'; ?>"><img src="<?php echo base_url(); ?>upload/news/<?php echo $item->image_link ?>" class="img-responsive" alt="<?php echo $item->title ?>" /></a></div>
                                <div class="col-md-9 col-sm-8 col-xs-12 news-info ">
                                    ...
                                    <div class="desc"><p><?php echo $item->intro  ?></p>
                                    </div>

                                    <div class="right" style="float: right;">
                                        <a href="<?php echo base_url('news/view/'.$item->id).'/'.safe_title($item->title).'.html'; ?>" "email me">Xem tiếp</a>
                                    </div>
                                </div>
                            </div>
                        </div>
